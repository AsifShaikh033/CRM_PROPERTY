          ...
          <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.web_config.banner_section') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="banner_title" class="form-control" id="banner_title" value="{{ $settings['banner_title'] ?? '' }}" placeholder="Enter Banner Title">
                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-12">
                                    <div class="form-group">
                                        <label for="banner_description">Description</label>
                                        <input type="text" name="banner_description" class="form-control" id="banner_description" value="{{ $settings['banner_description'] ?? '' }}" placeholder="Enter Banner Description">
                                    </div>
                                </div>
                            </div>
