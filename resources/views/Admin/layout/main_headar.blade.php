@php
    ...
    $notifications = NotificationHelper::getNotifications(10);
    $notificationCount = NotificationHelper::getUnreadCount();
@endphp
<div class="main-header">
    ...
    <div class="dropdown-title">
        ...
        {{ $notificationCount == 1 ? 'new notification' : 'new notifications' }}
    </div>
</li>
            ...
            @forelse($notifications as $notification)
                ...
                <a href="#">
                    <div class="notif-icon notif-primary">
                        ...
                        @if($notification->type == 'property_add' || $notification->type == 'property_edit')
                            <i class="fa fa-home"></i>

                        @elseif($notification->type == 'lead_add' || $notification->type == 'lead_edit')
                            <i class="fa fa-user"></i>

                        @elseif($notification->type == 'property_visit_add' || $notification->type == 'property_visit_edit')
                            <i class="fa fa-calendar"></i>

                        @elseif($notification->type == 'booking_add' || $notification->type == 'booking_edit')
